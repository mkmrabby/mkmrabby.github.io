...
<table class="table__tablenospace">
  <tr>
    <td class="table__tablenospace"><img src='/images/NCAT.png' style='height:100px;width:250px'></td>
  ...
  <tr>
    <td class="table__tablenospace"><img src='/images/ACCESSlab.png' style='height:80px;width:250px'></td>
    <td class="table__tablenospace" width="600px">
      <span style="color:black; font-size:17px">
